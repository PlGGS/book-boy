...
draw_sprite_ext(spr_example_arrow, 0, room_width * 0.5 + 48, room_height - 82, 1, 1, 0, c_white, 1);
draw_sprite_ext(spr_example_arrow, 0, room_width * 0.5 - 48, room_height - 82, -1, 1, 0, c_white, 1);
draw_sprite_ext(spr_example_arrow, 1, room_width * 0.5 + 140, room_height - 82, 1, 1, 0, c_white, 1);
draw_sprite_ext(spr_example_arrow, 1, room_width * 0.5 - 140, room_height - 82, -1, 1, 0, c_white, 1);

// Makes sure the surfaces used by the book exist and are assigned as textures for the sheets that use them.
example_set_surfaces();
