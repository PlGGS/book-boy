...
if (ib_book_get_right_sheet(objBook.book) == objBook.sheet_buttons && !ib_book_is_transitioning(objBook.book)) {
    ...
    if (position_meeting(mouse_transformed[0], mouse_transformed[1], id)) {
        ...
        if (mouse_check_button_pressed(mb_left)) {
            switch (button_id) {
                case 0: ib_book_goto_sheet(objBook.book, 0); break;
                case 1: ib_book_goto_sheet(objBook.book, 16); break;
            }
        }
    }
}
